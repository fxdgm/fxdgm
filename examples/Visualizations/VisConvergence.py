...
axs[0].set_xlabel(r'$\log(n_x)$', fontsize=labelsize)
axs[0].set_ylabel(r'log($e_2(f)$)', fontsize=labelsize)
axs[0].grid()
...
axs[1].set_xlabel(r'$\log(n_x)$', fontsize=labelsize)
axs[1].set_ylabel(r'log($e_\infty(f)$)', fontsize=labelsize)
axs[1].grid()
