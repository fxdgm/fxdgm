...
ax1_dimless.grid()
ax1_dimless.set_xlabel(r'$\delta \varphi [-]$', color=color_dimless, fontsize=labelsize)
...
ax1_dim.set_xlabel(r'$\delta \varphi [V]$', color=color_dim, fontsize=labelsize) 
ax1_dim.set_ylabel('$Q$ [\u03bc$C/cm^2]$', color=color_dim, fontsize=labelsize)       
...
ax2_dimless.grid()
ax2_dimless.set_xlabel(r'$\delta \varphi [-]$', color=color_dimless, fontsize=labelsize)
...
ax2_dim.set_xlabel(r'$\delta \varphi [V]$', color=color_dim, fontsize=labelsize) 
...
for i, q_dl in enumerate(Q_DL_dimless_):
    ax1_dimless.plot(Phi_Pot_Diff_dimless, q_dl, color=colors[i+1], label=rf'$\kappa$: {kappa_vec[i]}', lw=lw)
ax1_dimless.grid()
ax1_dimless.set_xlabel(r'$\delta \varphi [-]$', color=color_dimless, fontsize=labelsize)
ax1_dimless.set_ylabel('$Q [-]$', color=color_dimless, fontsize=labelsize)
ax1_dimless.tick_params(axis='x', colors=color_dimless, labelsize=labelsize)
...
# Plot dimensionless data
for i, q_dl in enumerate(Q_DL_dimless_):
    ax1_dimless.plot(Phi_Pot_Diff_dimless, q_dl, color=colors[i], label=rf'$\lambda^2$: {Lambda2_vec[i]}', lw=lw)
ax1_dimless.grid()
ax1_dimless.set_xlabel(r'$\delta \varphi [-]$', color=color_dimless, fontsize=labelsize)
ax1_dimless.set_ylabel('$Q [-]$', color=color_dimless, fontsize=labelsize)
ax1_dimless.tick_params(axis='x', colors=color_dimless, labelsize=labelsize)
