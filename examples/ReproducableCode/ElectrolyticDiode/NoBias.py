...
Solve the electrolitic diode without a bias
'''
...
# Save the results
np.savez('../../Data/ElectrolyticDiode/NoBias.npz', phi_bias=phi_bias, g_phi=g_phi, y_fixed=y_fixed, z_A=z_A, z_C=z_C, K=K, Lambda2=Lambda2, a2=a2, number_cells=number_cells, Lx=Lx, Ly=Ly, x0=x0, x1=x1, solvation=0, rtol=rtol, relax_param=relax_param, max_iter=max_iter, y_A=y_A, y_C=y_C, y_S=y_S, phi=phi, p=p, x=x, y=y)
