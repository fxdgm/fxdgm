...
This script simulates mixture 5 from the thesis
'''
...
phi_right = 0.0
p_right = 0.0
y_alpha_R = [1/5, 1/5, 1/5, 1/5]
z_alpha = [-2.0, -1.0, 1.0, 2.0]
K = 'incompressible'
Lambda2 = 8.553e-6
a2 = 7.5412e-4
number_cells = 1024*4
...
np.savez('../../Data/NConstituentsMixture/Mixture_5.npz', x=x_n, phi=phi_n, p=p_n, y_alpha=y_alpha_n, z_alpha=z_alpha, y_alpha_R=y_alpha_R, phi_left=phi_left, phi_right=phi_right, p_right=p_right, K=K, Lambda2=Lambda2, a2=a2, number_cells=number_cells)
