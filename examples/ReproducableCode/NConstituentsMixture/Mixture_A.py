...
This script simulates mixture A from the thesis
'''
...
np.savez('../../Data/NConstituentsMixture/Mixture_A.npz', x=x_n, phi=phi_n, p=p_n, y_alpha=y_alpha_n, z_alpha=z_alpha, y_alpha_R=y_alpha_R, phi_left=phi_left, phi_right=phi_right, p_right=p_right, K=K, Lambda2=Lambda2, a2=a2, number_cells=number_cells)
