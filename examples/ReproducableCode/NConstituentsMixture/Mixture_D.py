...
This script simulates mixture D from the thesis
'''
...
phi_right = 0.0
p_right = 0.0
y_alpha_R = [1/23, 1/23, 1/23, 1/23, 10/23]
...
np.savez('../../Data/NConstituentsMixture/Mixture_D.npz', x=x_n, phi=phi_n, p=p_n, y_alpha=y_alpha_n, z_alpha=z_alpha, y_alpha_R=y_alpha_R, phi_left=phi_left, phi_right=phi_right, p_right=p_right, K=K, Lambda2=Lambda2, a2=a2, number_cells=number_cells)
